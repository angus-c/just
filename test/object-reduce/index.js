...
test('use value', function (t) {
  ...
  var result1 = reduce(obj, function (target, key, value) {
    target.push(value);
    return target;
  }, []);
  t.ok(compare(result1, [3, 5, 9, null, noop]));

  var result2 = reduce(obj, function (target, key, value) {
...
test('use key', function (t) {
  ...
  var result2 = reduce(obj, function (target, key, value, index) {
    target[index] = key;
    return target;
  }, {});
