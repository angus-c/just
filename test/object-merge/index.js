...
var extend = require('../../packages/object-merge');

test('merges properties', function(t) {
  t.plan(1);
  var src = {a: 3, b: 5};
  extend(src, {a: 4, c: 8});
...
test('merges into empty object', function(t) {
  t.plan(1);
  var src = {};
...
test('does not clone child objects', function(t) {
  t.plan(3);
  var obj = {p: 4};
  var src2 = {a: 3, b: 5};
  extend(src2, {c: obj});
