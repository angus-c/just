...
test('using strings option', function(t) {
  ...
  t.deepEqual(unique(['a', 'b', 'a', 'b', 'a', 'c'], false, true), [
    'a',
    'b',
    'c',
  ]);
  ...
  t.deepEqual(unique([1, 2, 1, 2, 3, 3, 4, 4], false, true), [
    '1',
    '2',
    '3',
    '4',
  ]);
  t.deepEqual(unique([false, true, false, false], false, true), [
    'false',
    'true',
  ]);
  ...
  var fn2 = function() {};
  var fn3 = function() {};
  t.deepEqual(unique([fn1, fn2, fn3, fn2, fn3, fn2], false, true), [
    fn1,
    fn2,
    fn3,
  ]);
  ...
  t.notDeepEqual(unique([1, 2, '1', 2, '3', false], false, true), [
    1,
    2,
    '1',
    '3',
  ...
  t.deepEqual(unique(['a', 'b', 'b', 'b', 'b', 'c'], true, true), [
    'a',
    'b',
    'c',
  ]);
